...
def main(extraction_type):
    if extraction_type == 'A':
        ...
        with io.open('../output-extraction/result_regex_overstock1.json', 'w') as f:
        ...
        with io.open('../input-extraction/jewelry02.html', mode='r', encoding='windows-1252') as file:
            html = file.read()
        res = regular.extract_from_overstock(html)
        with io.open('../output-extraction/result_regex_overstock2.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        with io.open('../output-extraction/result_regex_rtvslo1.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        with io.open('../input-extraction/car2.html',
            ...
            html = file.read()
        res = regular.extract_from_rtvslo(html)
        with io.open('../output-extraction/result_regex_rtvslo2.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        with io.open('../output-extraction/result_regex_zurnal1.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        with io.open('../input-extraction/audi.html', mode='r', encoding='utf-8') as file:
            htmlContent = file.read()
        res = regular.extract_from_zurnal24(htmlContent)
        with io.open('../output-extraction/result_regex_zurnal2.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        with io.open('../output-extraction/result_xpath_overstock1.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        with io.open('../input-extraction/jewelry02.html', mode='r', encoding='windows-1252') as file:
            html = file.read()
        res = xpath.extract_from_overstock(html)
        with io.open('../output-extraction/result_xpath_overstock2.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        with io.open('../output-extraction/result_xpath_rtvslo1.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        with io.open('../input-extraction/car2.html',
            ...
            html = file.read()
        res = xpath.extract_from_rtvslo(html)
        with io.open('../output-extraction/result_xpath_rtvslo2.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        with io.open('../output-extraction/result_xpath_zurnal1.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        with io.open('../input-extraction/audi.html', mode='r', encoding='utf-8') as file:
            htmlContent = file.read()
        res = xpath.extract_from_zurnal24(htmlContent)
        with io.open('../output-extraction/result_xpath_zurnal2.json', 'w') as f:
            json.dump(json.loads(res), f, indent=4)
        print(json.dumps(json.loads(res), indent=4))
        ...
        road_runner('../input-extraction/car1.html', '../input-extraction/car2.html', UTF,
                    file='../output-extraction/result_road_runner_rtvslo.txt')
        ...
        road_runner('../input-extraction/polo.html', '../input-extraction/audi.html', UTF,
                    file='../output-extraction/result_road_runner_zurnal.txt')
    else:
